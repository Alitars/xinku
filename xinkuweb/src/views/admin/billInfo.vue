 ...
 * @LastEditors: voanit
 * @LastEditTime: 2020-11-09 10:03:06
-->
<template>
  <div class="cotainer">
    <!-- 头部标题 -->
    ...
    <div class="info">
      ...
      <div class="input">
        <el-form
          ...
          :rules="rules"
        >
          <el-form-item label="开户名称" prop="company">
            <el-input
    ...
    <div class="info">
      ...
      <div class="input">
        <el-form
          ...
          :inline="true"
        >
          <el-form-item label="账户名称" prop="company">
            <el-input
              v-model="formBill.company"
              clearable
              style="width: 200px"
              placeholder="请输入账户名称"
            ></el-input>
          ...
          <el-form-item label="纳税人识别号" prop="checkCode">
            <el-input
              v-model="formBill.checkCode"
              clearable
              style="width: 200px"
              maxlength="18"
